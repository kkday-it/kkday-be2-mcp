...
//   - announcement：src/modules/announcement/create/keys.ts#itemKey → announce:name:prod_oids:start_time
...
// 用 diff item 的形狀分辨：announcement 只有 prod_oids[]（無 item_oid）；inventory 帶 item_oid；其餘走 shelf。
